...
import { History, Plus, Trash2, Settings } from 'lucide-react';
import { cn } from '@/lib/utils';
import { SettingsModal } from '@/components/settings/SettingsModal';

export function Sidebar() {
    const { sidebarOpen, storedSessions, loadSessions, loadSession, deleteSession, createNewSession, currentSessionId, toggleSidebar } = useFlowStore();
    ...
    return (
        <>
            ...
            <aside className={cn(
                "bg-zinc-900 border-r border-zinc-800 flex flex-col transition-all duration-300 z-40",
